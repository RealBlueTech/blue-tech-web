      ...
      <div className="container relative z-10 mx-auto px-4">
        <div className="mx-auto max-w-4xl rounded-2xl bg-slate-900 p-8 text-white shadow-xl md:p-12">
          <div className="grid gap-8 md:grid-cols-2">
            <div>
              <h2 className="mb-4 text-3xl font-bold tracking-tight">Ready to Transform Your Business?</h2>
              <p className="mb-6 text-slate-300">
                Let's discuss how we can develop a custom solution tailored to your specific business needs. Our team of
                experts is ready to help you achieve your technology goals.
              </p>
