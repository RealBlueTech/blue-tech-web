    ...
    <section className="relative overflow-hidden bg-slate-50 py-20">
      ...
      <div className="container relative z-10 mx-auto px-4">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h2 className="mb-4 text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl">Meet Our Team</h2>
          <p className="mb-12 text-lg text-slate-600">
            Our talented team brings together diverse skills, experiences, and perspectives to deliver exceptional
            technology solutions for our clients.
          </p>
        </div>

        <div className="mx-auto max-w-6xl">
          <h3 className="mb-8 text-2xl font-bold text-slate-900">Leadership Team</h3>
          <div className="grid gap-8 md:grid-cols-3">
            {leadershipTeam.map((member, index) => (
              ...
              >
                ...
                <div className="p-6">
                  <h4 className="text-xl font-semibold text-slate-900">{member.name}</h4>
          ...
          <h3 className="mb-8 mt-16 text-2xl font-bold text-slate-900">Department Heads</h3>
          ...
          <div className="mt-12 rounded-xl border border-slate-100 bg-white p-8 shadow-sm">
            <div className="flex flex-col items-center justify-between gap-6 md:flex-row">
              <div>
                <h4 className="mb-2 text-xl font-semibold text-slate-900">Join Our Team</h4>
