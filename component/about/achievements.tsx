...
export default function Achievements() {
  const awards = [
    ...
    },
    {
      ...
      year: "2021",
      image:
        "https://images.unsplash.com/photo-1619824130478-2fb945b98ae1?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mzl8fHNvZnR3YXJlJTIwYXdhcmRzfGVufDB8fDB8fHww",
    },
    {
      ...
      <div className='container relative z-10 mx-auto px-4'>
        <div className='mx-auto max-w-3xl text-center'>
          ...
          <p className='mb-12 text-lg text-slate-600'>
            ...
            innovation, and quality in everything we do.
          </p>
        </div>
          ...
          <div className='mb-16 rounded-xl border border-slate-100 bg-white p-8 shadow-sm'>
            ...
            <div className='grid gap-8 md:grid-cols-3'>
              {awards.map((award, index) => (
                ...
                >
                  <div className='mb-4 h-20 w-20 rounded-lg bg-slate-100 flex items-center justify-center overflow-hidden'>
                    <Image
              ...
              <div className='flex items-center'>
                ...
                <div>
                  ...
                  <p className='text-slate-300'>
                    98% of our clients rate our services as excellent or very
                    good
                  </p>
                </div>
              </div>
