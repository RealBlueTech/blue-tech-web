...
export default function CompanyStory() {
  const milestones = [
    ...
    },
    {
      ...
      description: "Continuing to innovate and expand our capabilities to meet evolving client needs.",
    },
  ]
    ...
    <section className="relative overflow-hidden bg-slate-50 py-20">
      ...
      <div className="container relative z-10 mx-auto px-4">
        <div className="mx-auto max-w-3xl text-center">
          <h2 className="mb-4 text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl">Our Journey</h2>
          <p className="mb-12 text-lg text-slate-600">
            From our humble beginnings to becoming a leading technology solutions provider, our journey has been defined
            by innovation, growth, and a relentless focus on client success.
          </p>
        </div>
            ...
            {milestones.map((milestone, index) => (
              <div key={index} className={`relative flex ${index % 2 === 0 ? "justify-start" : "justify-end"}`}>
                ...
                >
                  ...
                  <h3 className="mb-2 text-xl font-semibold text-slate-900">{milestone.title}</h3>
        ...
        <div className="mx-auto mt-20 max-w-5xl rounded-xl bg-white p-8 shadow-sm">
          <div className="grid gap-8 md:grid-cols-2 md:gap-12">
            <div>
              <h3 className="mb-4 text-2xl font-bold text-slate-900">Our Founding Story</h3>
              <p className="mb-4 text-slate-600">
                BlueTech was founded in 2008 by a group of technology enthusiasts who saw the potential for
                businesses to transform through digital innovation. What began as a small web development agency quickly
                evolved into a comprehensive technology solutions provider.
              </p>
              <p className="text-slate-600">
                Our founders' vision was simple: to make cutting-edge technology accessible to businesses of all sizes,
                helping them compete and thrive in an increasingly digital world. This vision continues to guide us
                today.
              </p>
            </div>
