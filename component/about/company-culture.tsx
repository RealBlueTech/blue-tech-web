...
export default function CompanyCulture() {
  const benefits = [
    ...
    },
    {
      ...
      description:
        "Regular training, workshops, and conference opportunities to keep your skills sharp.",
    },
    {
    ...
    },
    {
      ...
      title: "Recognition",
      description:
        "Regular recognition programs to celebrate achievements and contributions.",
    },
    {
      icon: <Briefcase className='h-5 w-5' />,
      title: "Career Growth",
      description:
        "Clear career paths and mentorship opportunities to help you grow professionally.",
    },
    {
      icon: <Zap className='h-5 w-5' />,
      title: "Innovation Time",
      description:
        "Dedicated time to work on passion projects and explore new technologies.",
    },
  ];
      ...
      <div className='container relative z-10 mx-auto px-4'>
        <div className='mx-auto max-w-3xl text-center'>
          ...
          <p className='mb-12 text-lg text-slate-600'>
            We've built a collaborative, innovative, and inclusive culture where
            our team members can thrive and do their best work.
          </p>
        </div>
        ...
        <div className='mx-auto mb-16 grid max-w-6xl gap-8 md:grid-cols-2'>
          <div className='order-2 space-y-6 md:order-1'>
            ...
            <p className='text-lg text-slate-600'>
              At BlueTech, we believe that our success is directly tied to the
              happiness and growth of our team members. We've created an
              environment that fosters creativity, collaboration, and continuous
              learning.
            </p>
            <p className='text-lg text-slate-600'>
              Our open and inclusive culture encourages diverse perspectives and
              ideas, leading to better solutions for our clients and more
              opportunities for innovation.
            </p>
            <div className='rounded-lg bg-slate-50 p-6'>
              <blockquote className='italic text-slate-700'>
                "What sets BlueTech apart is the culture of collaboration and
                innovation. Everyone is encouraged to share ideas and take
                ownership of their work. It's the most supportive and dynamic
              ...
              <div className='mt-4 flex items-center'>
                ...
                <div className='ml-3'>
                  <p className='font-medium text-slate-900'>Baraka Nampellah</p>
                  <p className='text-sm text-slate-500'>
                    Senior Developer, 5 years at BlueTech
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className='order-1 md:order-2'>
            <div className='grid grid-cols-2 gap-4'>
              <div className='overflow-hidden rounded-lg'>
                <Image
                  src='https://images.unsplash.com/photo-1740042479040-da6c20fa3dbf?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MjZ8fGJsYWNrJTIwcGVvcGxlJTIwd29ya2luZyUyMGluJTIwb2ZmaWNlfGVufDB8fDB8fHww'
                  width={300}
                  height={300}
                  alt='Company culture'
                  className='h-full w-full object-cover'
              ...
              <div className='overflow-hidden rounded-lg'>
                <Image
                  src='https://images.unsplash.com/photo-1653565685060-e15e492a7fda?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8YmxhY2slMjBwZW9wbGUlMjBvZmZpY2UlMjBjdWx0dXJlfGVufDB8fDB8fHww'
                  width={300}
                  height={300}
                  alt='Company culture'
                  className='h-full w-full object-cover'
