  ...
  const technologyCategories = [
    {
      ...
      technologies: [
        ...
        { name: "Angular", image: "/placeholder.svg?height=60&width=60" },
    ...
    },
    {
      ...
      technologies: [
        ...
        { name: "PHP", image: "/placeholder.svg?height=60&width=60" },
        { name: ".NET", image: "/placeholder.svg?height=60&width=60" },
        { name: "Ruby", image: "/placeholder.svg?height=60&width=60" },
      ],
    },
    {
      category: "Mobile",
      technologies: [
        { name: "React Native", image: "/placeholder.svg?height=60&width=60" },
        { name: "Flutter", image: "/placeholder.svg?height=60&width=60" },
        { name: "Swift", image: "/placeholder.svg?height=60&width=60" },
        { name: "Kotlin", image: "/placeholder.svg?height=60&width=60" },
        { name: "Ionic", image: "/placeholder.svg?height=60&width=60" },
        { name: "Xamarin", image: "/placeholder.svg?height=60&width=60" },
      ],
    },
    {
      ...
      technologies: [
        ...
        { name: "Azure", image: "/placeholder.svg?height=60&width=60" },
        ...
        { name: "Jenkins", image: "/placeholder.svg?height=60&width=60" },
      ],
    },
  ]
